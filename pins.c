...
{
     // set P1 GPIOs
    P1SEL &= ~(GPIO_AUDIO_CHAN1_ENABLE | GPIO_AUDIO_REC1_ENABLE | GPIO_RADIO_BUSY | GPIO_SIGDIR);
    // intialize output pins
    P1OUT |= GPIO_USCI_SS;
    P1OUT &= ~(GPIO_AUDIO_CHAN1_ENABLE | GPIO_AUDIO_REC1_ENABLE | GPIO_SIGDIR);
    // set up output pins
    P1DIR |= GPIO_AUDIO_CHAN1_ENABLE | GPIO_AUDIO_REC1_ENABLE | GPIO_USCI_SS | GPIO_SIGDIR;
    //set P1 input pins
    P1DIR &= ~(GPIO_RF_INPUT | GPIO_RADIO_BUSY);
    //set USCI to rst
    UCB0CTL1 = UCSWRST;
